  ...
  return (
    <SiteLayout>
      <article className="mx-auto max-w-3xl px-5 py-16">
        ...
        <p className="mt-3 text-sm text-muted-foreground">Effective Date: 2nd May, 2026</p>
        ...
        <div className="prose prose-neutral mt-10 max-w-none text-foreground">
          ...
          <h3 className="mt-6 font-display text-xl">1.1 Default No-Refund Rule</h3>
          ...
          <h3 className="mt-6 font-display text-xl">1.2 Limited Exceptions</h3>
          <p className="text-muted-foreground">
          ...
          <h3 className="mt-6 font-display text-xl">1.3 Non-Refundable Charges</h3>
          ...
          <h3 className="mt-6 font-display text-xl">1.4 Untraceable / Unverifiable Payments</h3>
          <p className="text-muted-foreground">
          ...
          <h3 className="mt-6 font-display text-xl">1.5 Method of Refund</h3>
          <p className="text-muted-foreground">
          ...
          <h3 className="mt-6 font-display text-xl">1.6 Processing Time</h3>
          <p className="text-muted-foreground">
          ...
          <h3 className="mt-6 font-display text-xl">3.1 Science of Stuck Webinar</h3>
          ...
          <h3 className="mt-6 font-display text-xl">3.2 Blocks to Breakthroughs</h3>
          ...
          <h3 className="mt-6 font-display text-xl">3.3 Breakthrough Blueprint (2-Day Bootcamp)</h3>
          ...
          <h3 className="mt-6 font-display text-xl">3.4 Breakthrough Flightpath</h3>
