      ...
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5">
        ...
        <div className="hidden items-center gap-2 md:flex">
          <a
            ...
            aria-label="Facebook"
            className="grid h-8 w-8 place-items-center rounded-full bg-[#1877F2] text-white transition-transform hover:scale-110"
          >
          ...
          <a
            ...
            className="grid h-8 w-8 place-items-center rounded-full bg-[#E4405F] text-white transition-transform hover:scale-110"
          >
          ...
          <a
            ...
            rel="noopener noreferrer"
            aria-label="YouTube"
            className="grid h-8 w-8 place-items-center rounded-full bg-[#FF0000] text-white transition-transform hover:scale-110"
          >
            ...
            <div className="mt-2 flex flex-col gap-2 border-t border-border pt-3">
              <div className="flex items-center gap-2">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() => setOpen(false)}
                  className="grid h-8 w-8 place-items-center rounded-full bg-[#E4405F] text-white"
                >
                  <InstagramIcon className="h-4 w-4" />
                </a>
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() => setOpen(false)}
                  className="grid h-8 w-8 place-items-center rounded-full bg-[#FF0000] text-white"
                >
                  <YouTubeIcon className="h-4 w-4" />
                </a>
              </div>
