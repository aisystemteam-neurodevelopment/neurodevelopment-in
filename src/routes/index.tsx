...
import heroBg from "@/assets/hero-new-bg-clean.png";
...
export const Route = createFileRoute("/")({
  head: () => ({
    ...
    meta: [
      ...
      { property: "og:title", content: "Institute of NeuroDevelopment — Parent-Led NeuroDevelopment System" },
      { property: "og:description", content: "Replace fragmented therapy with a structured developmental architecture parents can lead, every day." },
      ...
      { name: "twitter:description", content: "A structured, parent-led neurodevelopment system." },
    ],
  }),
  component: HomePage,
});
